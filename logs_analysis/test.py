...
# === Plot ===
fig = go.Figure()
fig.add_trace(go.Scatter(x=df["time"], y=acc_raw[:,0], mode="lines", name="ax"))
fig.add_trace(go.Scatter(x=df["time"], y=acc_raw[:,1], mode="lines", name="ay"))
fig.add_trace(go.Scatter(x=df["time"], y=acc_raw[:,2], mode="lines", name="az"))
